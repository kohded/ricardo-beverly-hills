...
@section('content')
    <div id="repair-center-claim-more-details" class="col-md-8 col-md-offset-2">
        {{--Claim--}}
        <div class="row">
            <div class="col-xs-12">
        ...
        <div class="row">
            <div class="panel panel-info">
                ...
                @endforeach
                    <tr><td colspan="3">
                        <form action="{{ route('repair-center-claim.add-comment') }}" method="post">
        ...
        <div class="row">
            <div class="col-xs-4">
                <a href="{{ route('repair-center-claim') }}" class="btn btn-primary">
                    Back
                </a>
            </div>
        </div>
